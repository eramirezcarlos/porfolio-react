...
const Welcome = () =>{
    ...
    return(
        <div id="home" className="welcome-area"  style={{ backgroundImage: `url(${BackgroundImage})`, backgroundAttachment: "fixed"}}>
            ...
            <div id="bgndVideo" class="player" data-property="{videoURL:'https://youtu.be/ZwCOeHTvdeQ', containment:'#home', showControls:false, autoPlay:true, loop:true, mute:true, startAt:0, opacity:0.5, addRaster:true, quality:'highres'}"></div>
